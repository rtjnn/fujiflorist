...
<section className="relative min-h-screen pt-32 pb-12 bg-white animate-fade-in-up">
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
            ...
            <a key={`${produk.nama}-${index}`}
                href={`https://api.whatsapp.com/send/?phone=6285722069952&text=${encodeURIComponent( `Halo saya tertarik
                dengan produk "${produk.nama}" ` )}`} target="_blank" rel="noopener noreferrer"
